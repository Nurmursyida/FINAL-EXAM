...
<body>
    ...
    <div class="w3-padding" style='max-width:900px;margin:auto'>
        <table class="w3-table w3-striped w3-bordered w3-panel w3-border">
            ...
            <?php $__currentLoopData = $listProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td><?php echo e($loop->iteration); ?></td>
                <td><?php echo e($listItem->subject_id); ?></td>
                <td><?php echo e($listItem->tutor_title); ?></td>
                <td><?php echo e($listItem->tutor_description); ?></td>
                <td><?php echo e($listItem->tutor_price); ?></td>
                <td><?php echo e($listItem->tutor_total); ?></td>
              
                <td>
                    <div class="w3-cell">
                        <form method="post" action="<?php echo e(route('markDelete',$listItem->id)); ?>" accept-charset="UTF-8" onsubmit="return confirm('Delete?');">
                    ...
                    <div class="w3-cell">
                        <button class="w3-button w3-round w3-block" onclick="document.getElementById('<?php echo e($loop->iteration); ?>').style.display='block';return false;"><i class="fa fa-pencil-square-o"> </i>
                        </button>
                    </div>
                    <div id="<?php echo e($loop->iteration); ?>" class="w3-modal w3-animate-opacity">
                        <div class="w3-modal-content w3-round" style="width:500px">
                            <header class="w3-row w3-blue"> <span onclick="document.getElementById('<?php echo e($loop->iteration); ?>').style.display='none'" class="w3-button w3-display-topright w3-small">&times;</span>
                                <h4 class="w3-margin-left">UPDATE SUBJECT FORM</h4>
                            </header>
                            <div class="w3-padding">
                                <form method="post" action="<?php echo e(route('markUpdate',$listItem->id)); ?>">
                                    <?php echo e(csrf_field()); ?>

                                    <p><input class="w3-input w3-round w3-border" type="text" name="ttitle" placeholder="Title" value ="<?php echo e($listItem->tutor_title); ?>"></p>
                                    <p><input class="w3-input w3-round w3-border" type="text" name="tdescription" placeholder="Description" value ="<?php echo e($listItem->tutor_description); ?>"></p>
                                    <p><input class="w3-input w3-round w3-border" type="number" name="tprice" placeholder="Price" step="any" value ="<?php echo e($listItem->tutor_price); ?>"></p>
                                    <p><input class="w3-input w3-round w3-border" type="number" name="ttotal" placeholder="Total" value ="<?php echo e($listItem->tutor_total); ?>"></p>
                                    </textarea></p>
    ...
    <div id="newitem" class="w3-modal w3-animate-opacity">
     ...
     ('newitem').style.display='none'" class="w3-button w3-display-topright w3-small">&times;</span>
            ...
            <div class="w3-padding">
                <form method="post" action="<?php echo e(route('saveSubject')); ?>">
                    <?php echo e(csrf_field()); ?>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\syidapage\resources\views/mainpage.blade.php ENDPATH**/ ?>